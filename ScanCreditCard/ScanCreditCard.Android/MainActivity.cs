...
namespace ScanCreditCard.Droid
{
    [Activity(Label = "ScanCreditCard", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
